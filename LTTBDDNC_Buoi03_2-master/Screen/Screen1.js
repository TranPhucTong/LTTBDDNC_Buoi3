...
export default function Screen1({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Option', {message : link,})} activeOpacity={0.5} style={{ flexDirection: "row", borderRadius: 10, borderWidth: 0.8, width: 332, height: 40, alignSelf: 'center', marginTop: 19 }}>
      ...
      <TouchableOpacity activeOpacity={0.5} style={{ bottom:100 ,flexDirection: "row", borderRadius: 10, borderWidth: 0.8, width: 332, height: 50, alignSelf: 'center', justifyContent: 'center', marginVertical: 160, backgroundColor: 'red' }}>
